...
public class dataProvider extends Android_BaseTest{
		...
		public Object[][] getData(){
			{
				return new Object[] [] {{"saikiranone@dcwvalidation","xyz@1234"},{"saikirantwo@dcwvalidation","xyz@1234"},{"saikiranthree@dcwvalidation","xyz@1234"},{"saikiranfour@dcwvalidation","xyz@1234"}};
